...
export declare namespace PToolSpace {
  /** 页面注册选项 */
  ...
  namespace Component {
    ...
    type Options<D, P extends PropertyOption, M extends Partial<MethodOption>> = WechatMiniprogram.Component.Options<D, P, M>;
    type WXInstance<D extends DataOption, P extends PropertyOption, M extends MethodOption> = PToolSpace.ComponentInstance<D> &
      Instance<D, P, M>;

    type WXOption<D extends DataOption, P extends PropertyOption, M extends MethodOption> = ThisType<WXInstance<D, P, M>> &
      Options<D, P, M>;
